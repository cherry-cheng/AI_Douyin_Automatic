...
const s2 = await inspectImageUploadState()
cliLog('final state: editorReady=' + s2.editorReady + ' uploading=' + s2.uploading + ' failed=' + s2.uploadFailed)
cliLog(s2.text.slice(0, 800))
